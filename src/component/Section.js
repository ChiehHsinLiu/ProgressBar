...
const Section = ({ index, objs, setObjs, change, setChange }) => {
  ...
  console.log("run Section", title, 'show', show, 'former', former, "preFormer.current", preFormer.current)
          ...
          <div className="Progress" style={{ width: "7px", height: "100%", backgroundColor: `${complete ? "Fuchsia" : "DarkGrey"}`, borderRadius: "8px", marginLeft: "10px" }}>
            ...
            <div className="TitleAndContent" >
              ...
              <div className="ContentAndButton">
                {former && <div>
                  <div className="content" style={{ marginLeft: "40px", whiteSpace: "pre-line" }}> {content} </div>
